...
<div class="models"><section><h2>AlphaMissense</h2><p>Looks up a precomputed prediction for a protein-changing variant. A missing match does not mean harmless.</p></section><section><h2>AlphaGenome</h2><p>Predicts molecular effects from DNA sequence. Results depend on the scorer, tissue and model; they are not a personal disease probability.</p></section><section><h2>AlphaGenome Atlas / AVI</h2><p>Looks up precomputed variant impact rankings and available feature contributions. AVI is an impact ranking, not a disease probability.</p></section></div>
